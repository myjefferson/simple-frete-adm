<?php
    ...
    class ConfigModel extends Model{
        ...
        public function updateConfigLightModeDB(string $lightMode){
            $db = db_connect();

            $update = $db->table('configuracoes')->set([
                "lightMode" => $db->escapeString($lightMode)
            ], false)->where(array(
            ...
            return $this->returnResponse( $update, true);
        }
