...
<div class="page-frete" id="page-pagamento">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div v-else id="content-pagamento" class="row">
                <div v-if="loading">
                ...
                <div v-else
                    ...
                    class="frete-pagamento col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6"
                >
                        ...
                        <div class="card-footer row">
                            ...
                            <div class="button-action btn-group col-4 no-padding">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" @click="confirmarPagamento(frete.FreteID)">Confirmar pagamento</a></li>
